...
const QMetaObject Boton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Boton.data,
      qt_meta_data_Boton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Boton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Boton.stringdata0))
        return static_cast<void*>(const_cast< Boton*>(this));
